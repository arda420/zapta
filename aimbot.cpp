...
void AimPlayer::SetupHitboxes(LagRecord* record, bool history) {
	...
	if (g_menu.main.aimbot.head1.get(1) && prefer_head && (record->m_flags & FL_ONGROUND))
		m_hitboxes.push_back({ HITBOX_HEAD, HitscanMode::PREFER });
	...
	if (core.m_weapon_id == GLOCK || core.m_weapon_id == P2000 || core.m_weapon_id == USPS || core.m_weapon_id == ELITE || core.m_weapon_id == P250 || core.m_weapon_id == TEC9 || core.m_weapon_id == CZ75A) {
	...
	else if (core.m_weapon_id == SSG08) {
	...
	else if (core.m_weapon_id == G3SG1 || core.m_weapon_id == SCAR20) {
	...
	else if (core.m_weapon_id == core.m_weapon_id == DEAGLE || core.m_weapon_id == REVOLVER) {
...
void Aimbot::find() {
	...
	if (best.player && best.record) {
		...
		else if (core.m_weapon_id == DEAGLE || core.m_weapon_id == REVOLVER)
...
bool Aimbot::CheckHitchance(Player* player, const ang_t& angle) {
	...
	if (core.m_weapon_id == ZEUS)
		hc = 90;
	else if (core.m_weapon_id == GLOCK || core.m_weapon_id == P2000 || core.m_weapon_id == USPS || core.m_weapon_id == ELITE || core.m_weapon_id == P250 || core.m_weapon_id == TEC9 || core.m_weapon_id == CZ75A)
...
bool AimPlayer::SetupHitboxPoints(LagRecord* record, BoneArray* bones, int index, std::vector< vec3_t >& points) {
	...
	if (bbox->m_radius <= 0.f) {
		...
		/*if (index == HITBOX_R_FOOT || index == HITBOX_L_FOOT) {
			...
			if (core.m_weapon_id == GLOCK || core.m_weapon_id == P2000 || core.m_weapon_id == USPS || core.m_weapon_id == ELITE || core.m_weapon_id == P250 || core.m_weapon_id == TEC9 || core.m_weapon_id == CZ75A || core.m_weapon_id == DEAGLE || core.m_weapon_id == REVOLVER) {
