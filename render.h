...
namespace render {
	...
	void init();
	void draw_3d_circle(vec3_t origin, float radius, float angle, Color color);
	void draw_3d_filled_circle(vec3_t origin, float radius, float angle, Color color);
	...
	void gradient(int x, int y, int w, int h, Color color1, Color color2, bool ciocan);
