...
void Chams::init() {
	...
	std::ofstream("csgo\\materials\\promethea_test.vmt") << R"#("VertexLitGeneric"
	{
	...
	m_materials.push_back(g_csgo.m_material_system->FindMaterial(XOR("debug/debugambientcube"), XOR("Model textures")));
	m_materials.push_back(g_csgo.m_material_system->FindMaterial(XOR("promethea_test"), XOR("Model textures")));
